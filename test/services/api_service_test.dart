...
void main() {
  ...
  group('ApiService', () {
    group('getMovies', () {
      ...
      test('returns empty list on 200 but no data in response', () async {
        // Arrange: tell the mock what to return for any GET
        when(mockClient.get(any)).thenAnswer(
          (_) async => http.Response(
            jsonEncode(
    ...
    group('getMovie', () {
      test('returns parsed movie on 200', () async {
        // Arrange: tell the mock what to return for any GET
        when(mockClient.get(any)).thenAnswer(
          (_) async => http.Response(
            jsonEncode(
        ...
        // Act
        final movie = await apiService.getMovie('123');
      ...
      test('returns null on 200 but empty response', () async {
        // Arrange: tell the mock what to return for any GET
        when(mockClient.get(any)).thenAnswer(
          (_) async => http.Response(
            '',
